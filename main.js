...
function details(det){
  ...
  mail.href="mailto:chowhanmunna16@gmail.com";
...
function careerinfo(car){
  ...
  info.textContent="career Objectives:";
...
function educationdetails(edu){
  ...
  for(var i=0;i<edu.length;i++){
    tr2+="<tr><td>"+edu[i].institude+"</td><td>"+edu[i].degree+"</td><td>+"+edu[i].passout+"</td></tr>"
  }
...
function technicalskills(tech){
  ...
  det.textContent = "technicalskills:";
